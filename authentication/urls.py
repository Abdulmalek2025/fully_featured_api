...
from authentication.views import (RegisterView, SetNewPasswordAPIView, VerifyEmail,
LoginAPIView, PasswordTokenCheckAPIView, RequestPasswordResetEmailAPIView)
